...
public class ResponseSpaceCalculator{
	
	//constructor 
	public ResponseSpaceCalculator(){}
	...
	public void analyzeData(Neuron n){
	  Stimulus[] st = (Stimulus[]) n.sensitiveStimuli().toArray();
	  for(int i = 0; i < st.length; i++){
	    ArrayList<Tuple<Integer,Integer,Double>> sample_space = this.createComparisionSpace(n,st[i]);	  
